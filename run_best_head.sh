...
do
    CUDA_VISIBLE_DEVICES=7 python3 meta_expl/train.py \
    --task mlqe \
    ...
    --teacher-explainer-params "{\"normalizer_fn\": \"softmax\", \"normalize_head_coeffs\": \"sparsemax\", \"aggregator_idx\": \"mean\", \"aggregator_dim\": \"row\", \"init_fn\": \"uniform\", \"layer_idx\": 9, \"head_idx\": 5}" \
