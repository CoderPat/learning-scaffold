...
@register_explainer("attention_value_explainer")
class AttentionValueExplainer(SaliencyExplainer):
    """
    ...
    and on the L2 norm of value vectors
    ...
    def logit_computation(
        ...
        head_values = (
            jnp.concatenate(all_values, axis=1)
            if self.layer_idx is None
