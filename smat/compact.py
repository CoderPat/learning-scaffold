    ...
    for epoch in range(max_epochs):
        ...
        for (train_x, train_y), (valid_x, valid_y) in zip(
            ...
            (
                ...
                criterion=criterion,
                update_fn=student_optimizer.update,
                student_params=student_params,
                student_explainer_params=s_explainer_params,
                teacher_params=teacher_params,
                teacher_explainer_params=t_explainer_params,
                opt_state=student_optstate,
                rng=next(keyseq),
                x=train_x,
                y=train_y,
                kld_coeff=explanation_regularizer,
            )
            ...
            _, t_explainer_params, explainer_optstate = explainer_train_step(
                ...
                criterion=criterion,
                update_fn=student_optimizer.update,
                metaupdate_fn=explainer_optimizer.update,
                student_params=student_params,
                student_explainer_params=s_explainer_params,
                teacher_params=teacher_params,
                teacher_explainer_params=t_explainer_params,
                opt_state=student_optstate,
                metaopt_state=explainer_optstate,
                rng=next(keyseq),
                train_x=train_x,
                train_y=train_y,
                valid_x=valid_x,
